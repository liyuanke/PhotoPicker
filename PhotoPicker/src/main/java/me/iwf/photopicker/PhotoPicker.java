...
public class PhotoPicker {
    ...
    public final static int EXTRA_TAILOR_DEFALUT = 0;//0 不裁剪
    public final static int EXTRA_TAILOR_RECT = 1;//1矩形裁剪
    public final static int EXTRA_TAILOR_CIRCLE = 2;//2圆形裁剪
    public final static String EXTRA_TAILOR_MODE = "EXTRA_TAILOR_MODE";
    public final static String EXTRA_TAILOR_WIDTH = "EXTRA_TAILOR_WIDTH";
    public final static String EXTRA_TAILOR_HEIGHT = "EXTRA_TAILOR_HEIGHT";
    public final static String EXTRA_TAILOR_CIRCLE_SIZE = "EXTRA_TAILOR_CIRCLE_SIZE";
    ...
    public static class PhotoPickerBuilder {
         ...
         * @return
         */
        public PhotoPickerBuilder clip() {
            return clip(0, 0);
        }

        public PhotoPickerBuilder clip(int width, int height) {
            mPickerOptionsBundle.putInt(EXTRA_TAILOR_MODE, EXTRA_TAILOR_RECT);
            mPickerOptionsBundle.putInt(EXTRA_TAILOR_WIDTH, width);
            mPickerOptionsBundle.putInt(EXTRA_TAILOR_HEIGHT, height);
            return this;
        }
         ...
         * @return
         */
        public PhotoPickerBuilder circleClip() {
            return circleClip(0);
        }

        public PhotoPickerBuilder circleClip(int size) {
            mPickerOptionsBundle.putInt(EXTRA_TAILOR_MODE, EXTRA_TAILOR_CIRCLE);
            mPickerOptionsBundle.putInt(EXTRA_TAILOR_CIRCLE_SIZE, size);
            return this;
        }
